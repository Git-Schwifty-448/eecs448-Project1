=begin
    ...
    Author: Abraham Dick
    Date Created: 9/8/17
    Description: Creates users and allows them to attend events already persisting in the sqlite3 database, then stores the updates
...
class User
    ...
    # In charge of operating the user class including getting data from the db and running private methods
    # to add users to events
    def run
    ...
    private
        ...
        def create_user(origin_time_slot)
            ...
            # get valid alpha input from the user and construct the username
            temp_name = @control.get_alpha("\n\n#{@spacer}Please enter your first name:")
